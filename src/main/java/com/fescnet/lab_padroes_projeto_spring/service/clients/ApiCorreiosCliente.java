 ...
 */
@FeignClient(name = "correios", url = "http://localhost:8080/simulacao/parceiro/correios")
public interface ApiCorreiosCliente {

    @PostMapping("/frete/cotacao")
    public RespostaCotacaoDeFrete criarCotacaoNosCorreios(@RequestBody RequisicaoCotacaoDeFrete requisicao);
}